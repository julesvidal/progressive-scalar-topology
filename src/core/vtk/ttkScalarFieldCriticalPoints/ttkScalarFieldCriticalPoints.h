...
public:
  ...
  vtkSetMacro(DecimationLevel, int);
  vtkSetMacro(StoppingDecimationLevel, int);
  vtkSetMacro(UseMultiresTriangulation, bool);
  vtkSetMacro(UseProgressive, bool);
  vtkSetMacro(IntegrateTrajectories, bool);
...
private:
  bool UseMultiresTriangulation;
  bool UseProgressive;
  bool IntegrateTrajectories;
  int DecimationLevel;
  int StoppingDecimationLevel;
  ...
  // vector<tuple<int, vector<ttk::SimplexId>, char, ttk::SimplexId>>
  // trajectories_;
  std::vector<std::vector<ttk::SimplexId>> trajectoriesMax_;
  std::vector<int> trajectoriesMaxDecimation_;
  std::vector<std::vector<ttk::SimplexId>> trajectoriesMin_;
